...
class LuoPlayer {
    ...
    async loadSong(songData, autoPlay = false) {
        try {
            ...
            // Load audio
            const audioSrc = songData.audio_file || songData.file_path;
    ...
    showError(message) {
        ...
        errorDiv.style.cssText = 'position: fixed; top: 20px; right: 20px; background: #dc3545; color: white; padding: 12px 20px; border-radius: 8px; z-index: 10000;';

...
try {
    ...
    // Get most popular news for sidebar (Today, This Week, This Month)
    $popular_today = [];
    $popular_week = [];
    $popular_month = [];
    try {
        if ($conn) {
            $checkNews6 = $conn->query("SHOW TABLES LIKE 'news'");
            if ($checkNews6->rowCount() > 0) {
                // Today - Most viewed news today
                try {
                ...
                // This Week - Most viewed news this week
                try {
                ...
                // This Month - Most viewed news this month
                try {
        ...
        error_log("Popular news query error: " . $e->getMessage());
        $popular_today = [];
        $popular_week = [];
        $popular_month = [];
    }
                        ...
                        <div id="popular-tab-content" style="padding: 15px;">
                                ...
                                <?php if (!empty($popular_today)): ?>
                                    ...
                                    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: <?php echo $index < count($popular_today) - 1 ? '1px solid #e0e0e0' : 'none'; ?>;">
                                        <a href="<?php echo !empty($pop['slug']) ? base_url('news/' . rawurlencode($pop['slug'])) : base_url('news/' . $pop['id']); ?>" style="text-decoration: none; color: inherit; display: block;">
                                            ...
                                            <h3 style="font-size: 14px; font-weight: 700; color: #2c3e50; margin: 0; line-height: 1.4;">
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div style="color: #999; font-size: 14px; text-align: center; padding: 20px;">No popular news today</div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="popular-content" data-content="week" style="display: none;">
                                <?php if (!empty($popular_week)): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div style="color: #999; font-size: 14px; text-align: center; padding: 20px;">No popular news this week</div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="popular-content" data-content="month" style="display: none;">
                                <?php if (!empty($popular_month)): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div style="color: #999; font-size: 14px; text-align: center; padding: 20px;">No popular news this month</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>

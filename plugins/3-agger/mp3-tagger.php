...
/**
 * Add admin menu - Hook into admin navigation
 */
add_action('admin_menu', function() {
    // The menu will be added via the admin header integration
    // This hook allows other plugins/themes to detect MP3 Tagger

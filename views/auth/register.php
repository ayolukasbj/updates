    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p>Create your account to start streaming music.</p>
            </div>
            ...
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    <label for="stage_name" class="form-label">Stage Name (Artist Name)</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="fas fa-microphone"></i></span>
                        <input type="text" class="form-control" id="stage_name" name="stage_name" value="<?php echo htmlspecialchars($_POST['stage_name'] ?? ''); ?>" required>
                    </div>
                    <div class="form-text">This will be displayed as your artist name on the platform.</div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-outline-secondary" id="toggleConfirmPassword" style="border-left: 0;">
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="terms" name="terms" value="1" <?php echo (isset($_POST['terms']) && $_POST['terms'] == '1') ? 'checked' : ''; ?> required>
                    <label class="form-check-label" for="terms">
                        I agree to the <a href="terms-of-service.php" target="_blank" class="text-decoration-none">Terms of Service</a> and <a href="privacy-policy.php" target="_blank" class="text-decoration-none">Privacy Policy</a>
                    </label>
                </div>

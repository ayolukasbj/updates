...
<form method="POST">
    ...
    <div class="card" style="margin-bottom: 30px;">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label>Base URL (Optional - Auto-detected if empty)</label>
                <input type="text" name="settings[base_url]" class="form-control" 
                       value="<?php echo htmlspecialchars($settings['base_url']['setting_value'] ?? ''); ?>"
                       placeholder="<?php echo htmlspecialchars(defined('SITE_URL') ? SITE_URL : ''); ?>">
                <small style="color: #6b7280;">Override auto-detected base URL. Leave empty to use auto-detection. Example: https://yourdomain.com/ or https://yourdomain.com/music/</small>
            </div>
            
            <div class="form-group">
                <label>Base Path (Optional - Auto-detected if empty)</label>
                <input type="text" name="settings[base_path]" class="form-control" 
                       value="<?php echo htmlspecialchars($settings['base_path']['setting_value'] ?? ''); ?>"
                       placeholder="<?php echo htmlspecialchars(defined('BASE_PATH') ? BASE_PATH : '/'); ?>">
                <small style="color: #6b7280;">Override auto-detected base path. Leave empty to use auto-detection. Example: / or /music/</small>
            </div>

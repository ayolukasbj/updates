...
function deleteFiles($root_path, $extract_path = null) {
    ...
    foreach ($lines as $line_num => $line) {
        ...
        // realpath() returns false for non-existent files, which causes false security errors
        ...
        if (!$real_target || strpos($real_target_normalized, $real_root_normalized) !== 0) {
            ...
            $errors[] = $error_msg;
            logMessage("ERROR: $error_msg (target: $real_target_normalized, root: $real_root_normalized)");
            continue;
        }

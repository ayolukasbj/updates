<?php
// playlists.php - Browse playlists page
...
$playlists = $playlist->getPublicPlaylists(1, 20);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container" style="margin-top: 100px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <small class="text-muted">
                                    <i class="fas fa-user"></i> <?php echo htmlspecialchars($playlist_item['username']); ?>
                                </small>
                                <small class="text-muted">
        ...
        <?php if (empty($playlists)): ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">Be the first to create a playlist!</p>
                <?php if (is_logged_in()): ?>
                    <a href="create-playlist.php" class="btn btn-primary">Create Playlist</a>
                <?php else: ?>
                    <a href="login.php" class="btn btn-primary">Login to Create Playlist</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
